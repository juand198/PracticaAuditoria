...
require_once('controladores/ControladorAuditadas.php');
...
$controladorU = new ControladorAuditadas();

// Saco por pantalla en formato JSON el resultado
$vista->imprimir($controladorU->obtenerEmpresasAuditadasAuditora($idauditora));